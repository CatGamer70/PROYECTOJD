...
class PDF extends FPDF {
    // Cabecera
    function Header() {
        $this->Image("Recursos/Logo.png",10,8,25);
        ...
        $this->Cell(20, 10, utf8_decode('Color'), 1, 0, 'C',true);
        $this->Cell(35, 10, utf8_decode('Tamaño'), 1, 0, 'C',true);
        //$this->Cell(35, 10, utf8_decode('Imagen'), 1, 0, 'C',true);
        $this->Ln(10);
    }
...
while ($row = mysqli_fetch_assoc($resultado)) {
    ...
    $pdf->Cell(70, 10,  utf8_decode($row['descripcion']), 1, 0, 'C');
    $pdf->Cell(20, 10,  utf8_decode($row['cantidad']), 1, 0, 'C');
    $pdf->Cell(20, 10, $row['precio'], 1, 0, 'C');
    $pdf->Cell(20, 10, $row['color'], 1, 0, 'C');
    $pdf->Cell(35, 10, $row['tamano'], 1, 0, 'C');
   // $pdf->Cell(35, 10, $row['foto'], 1, 0, 'C');
    $pdf->Ln();
}
